...
! function(global, factory) {
    if ("function" == typeof define && define.amd) define("/App/Calendar", ["exports", "Site", "Config"], factory);
    else if ("undefined" != typeof exports) factory(exports, require("Site"), require("Config"));
    else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.Site, global.Config), global.AppCalendar = mod.exports
    }
    ...
    var _Site3 = babelHelpers.interopRequireDefault(_Site2),
        ...
        AppCalendar = function(_Site) {
            function AppCalendar() {
                return babelHelpers.classCallCheck(this, AppCalendar), babelHelpers.possibleConstructorReturn(this, (AppCalendar.__proto__ || Object.getPrototypeOf(AppCalendar)).apply(this, arguments))
            }
            return babelHelpers.inherits(AppCalendar, _Site), babelHelpers.createClass(AppCalendar, [{
                key: "initialize",
                value: function() {
                    babelHelpers.get(AppCalendar.prototype.__proto__ || Object.getPrototypeOf(AppCalendar.prototype), "initialize", this).call(this), this.$actionToggleBtn = $(".site-action-toggle"), this.$addNewCalendarForm = $("#addNewCalendar").modal({
                        show: !1
                    })
                }
            }, {
                key: "process",
                value: function() {
                    babelHelpers.get(AppCalendar.prototype.__proto__ || Object.getPrototypeOf(AppCalendar.prototype), "process", this).call(this), this.handleFullcalendar(), this.handleSelective(), this.handleAction(), this.handleListItem(), this.handleEventList()
                }
            }, {
                ...
                value: function() {
                    var myOptions = {
                            ...
                            eventClick: function(event) {
                                ...
                                $("#editEname").val(event.title), event.start ? $("#editStarts").datepicker("update", event.start._d) : $("#editStarts").datepicker("update", ""), event.end ? $("#editEnds").datepicker("update", event.end._d) : $("#editEnds").datepicker("update", ""), $("#editColor [type=radio]").each(function() {
                                    ...
                                    Config.colors(_value[0], _value[1]) === color ? $this.prop("checked", !0) : $this.prop("checked", !1)
                                }), $("#editNewEvent").modal("show").one("hidden.bs.modal", function(e) {
                                    event.title = $("#editEname").val();
                                    var color = $("#editColor [type=radio]:checked").data("color").split("|");
                                    color = Config.colors(color[0], color[1]), event.backgroundColor = color, event.borderColor = color, event.start = new Date($("#editStarts").data("datepicker").getDate()), event.end = new Date($("#editEnds").data("datepicker").getDate()), $("#calendar").fullCalendar("updateEvent", event)
                                })
                            },
                    ...
                    myOptionsMobile.aspectRatio = .5, _options = $(window).outerWidth() < 667 ? myOptionsMobile : myOptions, $("#editNewEvent").modal(), $("#calendar").fullCalendar(_options)
                }
            }, {
                key: "handleSelective",
                value: function() {
        ...
        instance = null;
    exports.default = AppCalendar, exports.AppCalendar = AppCalendar, exports.run = function() {
        getInstance().run()
