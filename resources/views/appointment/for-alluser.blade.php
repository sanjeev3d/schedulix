                              ...
                              <div class="col-md-12 common-height-div">
                                ...
                                <div class="col-md-12 common-height-div">
                                    <div class="form-group">
                                        ...
                                        <input class="typeahead form-control" type="text" name="customers_name" id="id-customer" autocomplete="off" placeholder="Enter customer name">
...
<script type="text/javascript">
    ...
    $(document).on('click','.close-modal',function(){
       // window.open(base_url + '/{123}/appointment', "_self");
    });
